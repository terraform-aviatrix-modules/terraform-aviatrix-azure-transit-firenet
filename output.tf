...
output "firewall_name" {
  ...
  value       = local.is_aviatrix ? null : (var.ha_gw ? [aviatrix_firewall_instance.firewall_instance_1[0].firewall_name, aviatrix_firewall_instance.firewall_instance_2[0].firewall_name]: [aviatrix_firewall_instance.firewall_instance[0].firewall_name])
}
